...
class GAT(torch.nn.Module):
    def __init__(self, in_dim, hidden_dim, out_dim):
        ...
        torch.manual_seed(12345)
        self.conv1 = GATConv(in_dim, 16, heads=8)
        self.conv2 = GATConv(16*8, out_dim, heads=1)
...
class ClusterGCNTrainer(object):
    ...
    def create_model(self):
        ...
        self.model = GAT(self.clustering_machine.feature_count, 32, self.clustering_machine.class_count)
        self.test_model = GAT(self.clustering_machine.feature_count, 32, self.clustering_machine.class_count)
    ...
    def train_random(self, train_idx=0, ratio=0.2):
        ...
        loss_tmp = 10e10
        clusters_tmp = random.sample(self.clustering_machine.clusters, math.ceil(self.args.cluster_number*ratio))
